;(function (window) {
  ...
  let texts = ['MY DEAR BEAR', 'ALISHA','LOOK UP AT THE', 'STARRY SKY', 'ARE YOU', 'LOOKING AT THE', 'SAME STAR', 'WITH ME ?', 'HAPPY','BIRTHDAY', 'ALISHA', 'I MISS YOU','THE SWEETEST GIRL','TO MY WIFE?']
